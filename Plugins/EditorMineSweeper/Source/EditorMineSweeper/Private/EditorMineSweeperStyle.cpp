...
TSharedPtr< FSlateStyleSet > FEditorMineSweeperStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FEditorMineSweeperStyle::Create()
{
	...
	Style->Set("EditorMineSweeper.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
